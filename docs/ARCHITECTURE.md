...
- Persistence/output/analysis: `persistence` (Phase 14 versioned checkpoint/resume), `diff` (Phase 15 offline checkpoint comparison), `analysis` (Phase 16 deterministic attention ranking), `graph`, `storage`, `output`
